...
import {
  retornarConjuntoDeDados,
  limparConsulta,
} from "../../utils/conjuntoDados";
...
export const ViewDadosProjetosPesquisa = () => {
  ...
  const conjuntoDeDado = retornarConjuntoDeDados("projetos de pesquisa");
  ...
  const consulta = {
    query: `
            query($filtros: InputsProjetoPesquisa) {
                projetosDePesquisa(filtros: $filtros) {
                    ${campos.join(",")}
                }
            }
        `,
